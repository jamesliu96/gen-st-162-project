...
def setButtons():
	...
	global confirmBut;
	confirmBut=swing.JButton("I belive I'm right!!", actionPerformed=isRight);
...
def isRight(event):
	#Button 1 is 0-60
	if (radioBut1.isSelected() and RValue < 61):
		print "Correct"
	#Button 2 is 61-120
	elif (radioBut2.isSelected() and RValue > 60 and RValue < 121):
		print "Correct"
	#Button 3 is 121-180
	elif (radioBut3.isSelected() and RValue > 120 and RValue < 181):
		print "Correct"
	#Button 4 is 181-255
	elif (radioBut4.isSelected() and RValue > 180):
		print "Correct"
	changeColor()
